...
pub use model::academic::{
    ...
    AcademicPdfFigureCompletion, AcademicPdfFigureRepair, AcademicPdfLocator,
    AcademicPdfPassReport, AcademicPdfProcessingReport, AcademicPdfReadInput,
    AcademicPdfReadOutput, AcademicPdfStructureInput, AcademicPdfStructureOutput,
    AcademicPdfStructureProfile, AcademicPdfTableCompletion, AcademicPdfTableRepair,
